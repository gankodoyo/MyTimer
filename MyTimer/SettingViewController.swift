...
class SettingViewController: UIViewController,UIPickerViewDataSource,UIPickerViewDelegate {
    ...
    override func viewDidLoad() {
        ...
        // timersettingPickerのデリゲートとデータソースの通知を指定
    ...
    */
    ...
    //picker選択時に実行
    func pickerView(_ pickerView: UIPickerView, didSelectRow row: Int, inComppnent component: Int) {
